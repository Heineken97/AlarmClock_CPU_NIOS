...
module CPU_Nios_mm_interconnect_0 (
		...
		input  wire [13:0] cpu_Nios_data_master_address,               //                 cpu_Nios_data_master.address
		...
		input  wire [13:0] cpu_Nios_instruction_master_address,        //          cpu_Nios_instruction_master.address
		...
		output wire [9:0]  memory_RAM_s1_address,                      //                        memory_RAM_s1.address
	...
	wire  [13:0] cpu_nios_data_master_translator_avalon_universal_master_0_address;              // cpu_Nios_data_master_translator:uav_address -> cpu_Nios_data_master_agent:av_address
	...
	wire  [87:0] rsp_mux_src_data;                                                               // rsp_mux:src_data -> cpu_Nios_data_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                              // cpu_Nios_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [2:0] rsp_mux_src_channel;                                                            // rsp_mux:src_channel -> cpu_Nios_data_master_agent:rp_channel
	...
	wire  [13:0] cpu_nios_instruction_master_translator_avalon_universal_master_0_address;       // cpu_Nios_instruction_master_translator:uav_address -> cpu_Nios_instruction_master_agent:av_address
	...
	wire  [87:0] rsp_mux_001_src_data;                                                           // rsp_mux_001:src_data -> cpu_Nios_instruction_master_agent:rp_data
	wire         rsp_mux_001_src_ready;                                                          // cpu_Nios_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire   [2:0] rsp_mux_001_src_channel;                                                        // rsp_mux_001:src_channel -> cpu_Nios_instruction_master_agent:rp_channel
	...
	wire  [13:0] cpu_nios_debug_mem_slave_agent_m0_address;                                      // cpu_Nios_debug_mem_slave_agent:m0_address -> cpu_Nios_debug_mem_slave_translator:uav_address
	...
	wire  [88:0] cpu_nios_debug_mem_slave_agent_rf_source_data;                                  // cpu_Nios_debug_mem_slave_agent:rf_source_data -> cpu_Nios_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [88:0] cpu_nios_debug_mem_slave_agent_rsp_fifo_out_data;                               // cpu_Nios_debug_mem_slave_agent_rsp_fifo:out_data -> cpu_Nios_debug_mem_slave_agent:rf_sink_data
	...
	wire  [87:0] cmd_mux_src_data;                                                               // cmd_mux:src_data -> cpu_Nios_debug_mem_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                              // cpu_Nios_debug_mem_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [2:0] cmd_mux_src_channel;                                                            // cmd_mux:src_channel -> cpu_Nios_debug_mem_slave_agent:cp_channel
	...
	wire  [13:0] pio_s1_agent_m0_address;                                                        // pio_s1_agent:m0_address -> pio_s1_translator:uav_address
	...
	wire  [88:0] pio_s1_agent_rf_source_data;                                                    // pio_s1_agent:rf_source_data -> pio_s1_agent_rsp_fifo:in_data
	...
	wire  [88:0] pio_s1_agent_rsp_fifo_out_data;                                                 // pio_s1_agent_rsp_fifo:out_data -> pio_s1_agent:rf_sink_data
	...
	wire  [87:0] cmd_mux_001_src_data;                                                           // cmd_mux_001:src_data -> pio_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                          // pio_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [2:0] cmd_mux_001_src_channel;                                                        // cmd_mux_001:src_channel -> pio_s1_agent:cp_channel
	...
	wire  [13:0] memory_ram_s1_agent_m0_address;                                                 // memory_RAM_s1_agent:m0_address -> memory_RAM_s1_translator:uav_address
	...
	wire  [88:0] memory_ram_s1_agent_rf_source_data;                                             // memory_RAM_s1_agent:rf_source_data -> memory_RAM_s1_agent_rsp_fifo:in_data
	...
	wire  [88:0] memory_ram_s1_agent_rsp_fifo_out_data;                                          // memory_RAM_s1_agent_rsp_fifo:out_data -> memory_RAM_s1_agent:rf_sink_data
	...
	wire         cmd_mux_002_src_valid;                                                          // cmd_mux_002:src_valid -> memory_RAM_s1_agent:cp_valid
	wire  [87:0] cmd_mux_002_src_data;                                                           // cmd_mux_002:src_data -> memory_RAM_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                          // memory_RAM_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [2:0] cmd_mux_002_src_channel;                                                        // cmd_mux_002:src_channel -> memory_RAM_s1_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                                  // cmd_mux_002:src_startofpacket -> memory_RAM_s1_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                                    // cmd_mux_002:src_endofpacket -> memory_RAM_s1_agent:cp_endofpacket
	wire         cpu_nios_data_master_agent_cp_valid;                                            // cpu_Nios_data_master_agent:cp_valid -> router:sink_valid
	wire  [87:0] cpu_nios_data_master_agent_cp_data;                                             // cpu_Nios_data_master_agent:cp_data -> router:sink_data
	...
	wire  [87:0] cpu_nios_instruction_master_agent_cp_data;                                      // cpu_Nios_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire         cpu_nios_debug_mem_slave_agent_rp_valid;                                        // cpu_Nios_debug_mem_slave_agent:rp_valid -> router_002:sink_valid
	wire  [87:0] cpu_nios_debug_mem_slave_agent_rp_data;                                         // cpu_Nios_debug_mem_slave_agent:rp_data -> router_002:sink_data
	wire         cpu_nios_debug_mem_slave_agent_rp_ready;                                        // router_002:sink_ready -> cpu_Nios_debug_mem_slave_agent:rp_ready
	wire         cpu_nios_debug_mem_slave_agent_rp_startofpacket;                                // cpu_Nios_debug_mem_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         cpu_nios_debug_mem_slave_agent_rp_endofpacket;                                  // cpu_Nios_debug_mem_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire  [87:0] pio_s1_agent_rp_data;                                                           // pio_s1_agent:rp_data -> router_003:sink_data
	...
	wire         memory_ram_s1_agent_rp_valid;                                                   // memory_RAM_s1_agent:rp_valid -> router_004:sink_valid
	wire  [87:0] memory_ram_s1_agent_rp_data;                                                    // memory_RAM_s1_agent:rp_data -> router_004:sink_data
	wire         memory_ram_s1_agent_rp_ready;                                                   // router_004:sink_ready -> memory_RAM_s1_agent:rp_ready
	wire         memory_ram_s1_agent_rp_startofpacket;                                           // memory_RAM_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         memory_ram_s1_agent_rp_endofpacket;                                             // memory_RAM_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         memory_ram_s1_agent_rdata_fifo_src_valid;                                       // memory_RAM_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] memory_ram_s1_agent_rdata_fifo_src_data;                                        // memory_RAM_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         memory_ram_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_002:in_0_ready -> memory_RAM_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                              // avalon_st_adapter_002:out_0_valid -> memory_RAM_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                               // avalon_st_adapter_002:out_0_data -> memory_RAM_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                              // memory_RAM_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                              // avalon_st_adapter_002:out_0_error -> memory_RAM_s1_agent:rdata_fifo_sink_error
	...
	CPU_Nios_mm_interconnect_0_cmd_demux_001 rsp_demux (
		.clk                (clk_cpu_clk_clk),                            //       clk.clk
		.reset              (cpu_Nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPU_Nios_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_cpu_clk_clk),                            //       clk.clk
		.reset              (cpu_Nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	CPU_Nios_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_cpu_clk_clk),                            //       clk.clk
		.reset              (cpu_Nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
