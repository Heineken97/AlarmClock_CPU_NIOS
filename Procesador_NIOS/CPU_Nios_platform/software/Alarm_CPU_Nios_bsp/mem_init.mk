...
# Memory: memory_RAM
MEM_0 := CPU_Nios_memory_RAM
$(MEM_0)_NAME := memory_RAM
...
$(MEM_0)_HIERARCHICAL_PATH := memory_RAM
$(MEM_0)_WIDTH := 32
...
.PHONY: memory_RAM
memory_RAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
